...
<body >
  ...
  <div class="container">
    ...
    <!-- www.123contactform.com script begins here -->
		...
		<link href="//cdn-main2.123contactform.com/modules/calculations/form/css/form.calculations.css.minified.css?ef276a2" rel="stylesheet" type="text/css"  />
		
		<script type="text/javascript"  src="//cdn-main1.123contactform.com/modules/calculations/form/js/form.calculations.js.minified.js?ef276a2"></script>
		...
		<script type="text/javascript"  src="//cdn-main1.123contactform.com/includes/interactive123cf.js.minified.js?ef276a2"></script>
		...
		<style type='text/css'>
			...
			.class123-label { font-family: "Open Sans", sans-serif; font-size: 16px; color: #4C4C4C; top:5px;  word-wrap: break-word; word-break: normal; }
			...
			#mainform123 .class123-sidebyside { display:inline-flex; vertical-align:bottom; float: none; }
		...
		<link href="//cdn-main2.123contactform.com/styles/form_fields.css?ef276a2" rel="stylesheet" type="text/css"  />
		
		<style type='text/css'>
		
				@media only screen and (max-width:600px){
					.divonecolumn {float:none; width:100%!important;}
					.not-preview label, .not-preview li, .not-preview .class123-likert, .not-preview .label-text {
			...
			/* --- BTV 30.05.2016: moved a lot of CSS to /styles/form_new.css --- */
			
		</style>
		
		<link href="//cdn-main.123contactform.com/styles/form_new.css?ef276a2" rel="stylesheet" type="text/css"  />
		<!--[if lte IE 8]>
		<style type='text/css'>
		...
		<style type='text/css'>
			...
			.class123-address .input-required {
				background-image: url("images3/asterix.gif");
				background-image: url("data:image/svg+xml;base64,");
		...
		<script type="text/javascript">
			...
			//-->
		</script><form  class="form js-form" action="https://www.123contactform.com/form-2264151/CAP-Contact-Form" id="mainform123" method="post" name="mainform123" enctype="multipart/form-data" novalidate>
		<input type="hidden" name="action" value="verify"/>
		<input type="hidden" size="30" name="viewformr" id="viewformr" value="cfr_1477166273.1882" />
		...
		<script type='text/javascript'>
			...
			js_ctype_arr['cid23027702']=0;
			js_cobject_arr['cid23027702']=0;
			js_ctype_arr['cid23027703']=0;
			js_cobject_arr['cid23027703']=0;
			js_ctype_arr['cid23027704']=0;
			js_cobject_arr['cid23027704']=0;
			js_ctype_arr['cid23027705']=1;
			js_cobject_arr['cid23027705']=0;
		...
		<label class="class123-label class123-fieldname class123-labelAligned  " id="id123-title23027702" for="id123-control23027702" >Name</label></div><div class="subitem rowright align-left"><input type="hidden" id="errorflagrow1" value=""/><div class="row control-row" ><div class="subitem col-lg-6 col-md-6 col-sm-6"><input  id="id123-control23027702" name="control23027702" placeholder="Name" class="form-control"   onclick=" InputActions(this,'row1');" onkeyup=" InputActions(this,'row1');  " onchange="InputRules(23027702); ;  " type="text" value=""  /></div></div></div></div>
		</div>
		<!-- fieldcontainer ends -->
		
		<!-- fieldcontainer -->
		<div id="fieldcontainer2" class="fieldcontainer currentPage1 currentPageActive  fieldwidth100 form-group      "  style="  ">
		<div id="row2" class="fieldtype-0-0 row row-fluid currentPage1 currentPageActive">
		<div class="subitem col-lg-3 rowleft col-md-3 col-sm-3">
		<label class="class123-label class123-fieldname class123-labelAligned  " id="id123-title23027703" for="id123-control23027703" >Email</label></div><div class="subitem  rowright align-left"><input type="hidden" id="errorflagrow2" value=""/><div class="row control-row" ><div class="subitem col-lg-6 col-md-6 col-sm-6"><input  id="id123-control23027703" name="control23027703"  placeholder="Email" class="form-control"  onclick=" InputActions(this,'row2');" onkeyup=" InputActions(this,'row2');  " onchange="InputRules(23027703); ;  " type="text" value=""  /></div></div></div></div>
		</div>
		<!-- fieldcontainer ends -->
		
		<!-- fieldcontainer -->
		<div id="fieldcontainer3" class="fieldcontainer currentPage1 currentPageActive  fieldwidth100 form-group      "  style="  ">
		<div id="row3" class="fieldtype-0-0 row row-fluid currentPage1 currentPageActive">
		<div class="subitem col-lg-3 rowleft col-md-3 col-sm-3">
		<label class="class123-label class123-fieldname class123-labelAligned  " id="id123-title23027704" for="id123-control23027704" >Subject</label></div><div class="subitem rowright align-left"><input type="hidden" id="errorflagrow3" value=""/><div class="row control-row" ><div class="subitem col-lg-6 col-md-6 col-sm-6"><input  id="id123-control23027704" name="control23027704"  placeholder="Subject" class="form-control"  onclick=" InputActions(this,'row3');" onkeyup=" InputActions(this,'row3');  " onchange="InputRules(23027704); ;  " type="text" value=""  /></div></div></div></div>
		</div>
		<!-- fieldcontainer ends -->
		
		<!-- fieldcontainer -->
		<div id="fieldcontainer4" class="fieldcontainer currentPage1 currentPageActive  fieldwidth100 from-group      "  style="  ">
		<div id="row4" class="fieldtype-1-0 row row-fluid currentPage1 currentPageActive">
		<div class="subitem col-lg-3 rowleft col-md-3 col-sm-3">
		<label class="class123-label class123-fieldname class123-labelAligned  " id="id123-title23027705" for="id123-control23027705" >Message</label></div><div class="subitem col-lg-6 rowright align-left col-md-6 col-sm-6"><input type="hidden" id="errorflagrow4" value=""/><div class="row control-row"><div class="subitem col-lg-12 col-md-12 col-sm-12"><div class="textarea-container force_block"><textarea  placeholder="Message" id="id123-control23027705" class="form-control" name="control23027705" onclick=" InputActions(this,'row4');" onkeyup=" InputActions(this,'row4');  " onchange="InputRules(23027705); ;  " rows="4"  ></textarea></div></div><div class="clear"></div></div></div></div>
		</div>
		<!-- fieldcontainer ends -->
		...
		<div class="row currentPage1 currentPageActive"><div class="rowright col-lg-9 col-md-9 col-sm-9 col-md-offset-3 col-lg-offset-3 col-sm-offset-3" align="left"><div class="row control-row"><div class="subitem col-lg-12 col-md-12 col-sm-12"><input type="hidden" name="go_back_and_edit" id="go_back_and_edit" value="0" /><button OnClick="  this.style.display='none'; insertPleaseWaitDiv(this,'Please wait...');  " type="submit" class="
						 no-default-image btn btn-cap submit-btn formdefaultbut"  style="" id="id123-button-send"  value="SUBMIT FORM">Submit</button> 
		</div></div></div>
		</div>
		...
		<input type="hidden" name="PHPSESSID" value="96lc184s7gju2r2v5ak20hdtu6"/>
		<div class="spam-trap">
